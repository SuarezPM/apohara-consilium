# Milan AI Week 2026 — Apohara PROBANT submission (paste-ready) · 12-VENDOR FROZEN VARIANT
...
```
12 frontier LLMs adversarially audit AI-generated code in isolated KV-caches. INV-15 Z3-proven. Tamper-evident verdict chain. Apache-2.0. EU AI Act Article 14 ready.
```

## Field: Long description (max ~2000 chars)
```
Apohara PROBANT is a reproducible benchmark + production tool for adversarial
auditing of AI-generated code. Gemini writes a review; 12 frontier vendors
(Claude, GPT, DeepSeek, Kimi, GLM, Qwen, Nemotron, MiniMax, Big-Pickle,
Mistral Large, Grok 2, Perplexity Sonar) independently judge it.
Aggregation: 0-2 harmful = verified · 3-5 = risky · 6+ = blocked.
