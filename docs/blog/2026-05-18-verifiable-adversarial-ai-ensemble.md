...
The live demo is at **[https://www.apohara.dev](https://www.apohara.dev)** (TechEx judging window, BYOK or 5 free/IP/day). An experimental SSR view of the landing page lives at **[https://apohara-nextjs.vercel.app](https://apohara-nextjs.vercel.app)** (Next.js 15 Server Components — content in initial HTML for crawlers).
